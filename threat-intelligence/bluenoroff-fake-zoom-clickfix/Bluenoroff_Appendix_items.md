...
| Resource Development | T1585.001 - Establish Accounts: Social Media Accounts                              | Calendly page created impersonating a well-known figure in the Fintech legal space; Telegram accounts hijacked from attacker's prior victims                                                                                                                                                                                                                                                                                                                                                             |
...
| Resource Development | T1588.005 - Obtain Capabilities: Exploits                                          | ChatGPT/GPT-4o used to generate synthetic portrait images (8 confirmed via C2PA provenance) for deepfake production pipeline                                                                                                                                                                                                                                                                                                                                                                             |
| Resource Development | T1587.001 - Develop Capabilities: Malware                                          | Structured deepfake production pipeline: AI portrait generation → VMware screen capture → Adobe Premiere Pro 2021 composition → FFmpeg encoding; operated from MacBook Pro (user "king") with dual-OS workflow                                                                                                                                                                                                                                                                                           |
| Initial Access       | T1566.002 - Phishing: Spearphishing Link                                           | Typosquatted Zoom URL delivered via modified Calendly/Google Meet calendar invite                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Execution            | T1204.001 - User Execution: Malicious Link                                         | Victim clicked typosquatted Zoom link (three times), then pasted ClickFix clipboard payload into terminal                                                                                                                                                                                                                                                                                                                                                                                               |
| Execution            | T1059.001 - Command and Scripting Interpreter: PowerShell                          | Multi-stage PowerShell execution chain: delivery cradle → obfuscated downloader → C2 implant → post-exploitation modules                                                                                                                                                                                                                                                                                                                                                                                |
| Execution            | T1059.003 - Command and Scripting Interpreter: Windows Command Shell               | cmd.exe used as intermediate execution step in ClickFix chain and persistence LNK                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Execution            | T1059.009 - Command and Scripting Interpreter: Cloud API                           | Telegram Bot API used for screenshot exfiltration via sendPhoto endpoint                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Persistence          | T1547.009 - Boot or Logon Autostart Execution: Shortcut Modification               | Chrome Update - Certificated.lnk in Startup folder re-executes C2 implant on every boot                                                                                                                                                                                                                                                                                                                                                                                                                |
| Privilege Escalation | T1548.002 - Abuse Elevation Control Mechanism: Bypass UAC                          | comBypassUacDLL.x64.dll uses COM elevation moniker (Elevation:Administrator!new) for privilege escalation                                                                                                                                                                                                                                                                                                                                                                                               |
| Defense Evasion      | T1027.013 - Obfuscated Files or Information: Encrypted/Encoded File                | Base64 + XOR 0x43 obfuscation across all PowerShell stages; AES-256-CBC encrypted shellcode payloads                                                                                                                                                                                                                                                                                                                                                                                                    |
| Defense Evasion      | T1140 - Deobfuscate/Decode Files or Information                                    | Runtime decoding of Base64+XOR payloads; AES decryption with PBKDF2-derived keys                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Defense Evasion      | T1055.001 - Process Injection: Dynamic-link Library Injection                      | Shellcode injected into Chromium browser processes (network.mojom PIDs) via OpenProcess/VirtualAllocEx/WriteProcessMemory/CreateRemoteThread                                                                                                                                                                                                                                                                                                                                                             |
| Defense Evasion      | T1620 - Reflective Code Loading                                                    | comBypassUacDLL.x64.dll loaded reflectively with PE header parsing and .vtt section offset execution                                                                                                                                                                                                                                                                                                                                                                                                    |
| Defense Evasion      | T1027.004 - Obfuscated Files or Information: Compile After Delivery                | C# source code compiled at runtime via Add-Type / csc.exe to create injector DLLs                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Defense Evasion      | T1036.005 - Masquerading: Match Legitimate Name or Location                        | Persistence files disguised as Chrome debug data (chrome-debug-data001.log, chromechip.log); LNK uses Chrome icon                                                                                                                                                                                                                                                                                                                                                                                       |
| Credential Access    | T1555.003 - Credentials from Password Stores: Credentials from Web Browsers        | File-based theft of Login Data, Cookies, Web Data from Chrome/Edge/Brave/Opera; in-memory credential harvesting via browser process injection targeting network.mojom PIDs; Stage B stealer queries SQLite Login Data databases with SELECT origin_url, username_value, password_value FROM logins using ?nolock=1 to avoid browser detection; AES-256-GCM decryption of credential blobs via BCrypt API; COM IElevator interface abuse to bypass Chrome 127+ app-bound encryption without SYSTEM privileges |
| Credential Access    | T1539 - Steal Web Session Cookie                                                   | Browser cookies exfiltrated from all Chromium browsers                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| Discovery            | T1518 - Software Discovery                                                         | Registry-based enumeration of installed software via Uninstall keys                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Discovery            | T1082 - System Information Discovery                                               | C2 beacon collects hostname, OS version, build number, install date, timezone, proxy settings; Stage B stealer collects GetComputerNameA, GetUserNameA, browser version, and generates fingerprint.json                                                                                                                                                                                                                                                                                                  |
| Discovery            | T1057 - Process Discovery                                                          | Process list enumerated on every beacon; VM detection via process name comparison                                                                                                                                                                                                                                                                                                                                                                                                                       |
| Discovery            | T1497.001 - Virtualization/Sandbox Evasion: System Checks                          | Process list compared against VMware, VirtualBox, Hyper-V, QEMU, and Parallels indicators; Stage A shellcode uses privileged I/O instructions (__in_oeax_dx, __outsd) that trigger VM-exits in hypervisors                                                                                                                                                                                                                                                                                              |
| Discovery            | T1217 - Browser Information Discovery                                              | Stage B stealer enumerates browser extensions (with focus on cryptocurrency wallet extensions), default search engine, autofill/password manager settings, and installed browser versions                                                                                                                                                                                                                                                                                                                |
| Collection           | T1113 - Screen Capture                                                             | Two methods: (1) Win32 API full-desktop JPEG capture via runtime C#; (2) .NET System.Drawing DPI-aware capture via Telegram Bot API                                                                                                                                                                                                                                                                                                                                                                     |
| Collection           | T1125 - Video Capture                                                              | Browser getUserMedia API captures victim's live camera feed during fake meeting                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Collection           | T1005 - Data from Local System                                                     | Telegram tdata/key_datas session files; browser extension data; Local Storage directories                                                                                                                                                                                                                                                                                                                                                                                                               |
| Exfiltration         | T1041 - Exfiltration Over C2 Channel                                               | System profiles and tasking results sent to C2 via HTTP POST                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| Exfiltration         | T1567 - Exfiltration Over Web Service                                              | Screenshots exfiltrated via Telegram Bot API; camera footage streamed via HTTP POST / WebSocket                                                                                                                                                                                                                                                                                                                                                                                                         |
| Exfiltration         | T1048.001 - Exfiltration Over Alternative Protocol: Exfiltration Over Symmetric Encrypted Non-C2 Protocol | Browser artifacts and Telegram sessions exfiltrated to separate infrastructure (104[.]145[.]210[.]107) via HTTPS                                                                                                                                                                                                                                                                                                                                                                                         |
| Command and Control  | T1071.001 - Application Layer Protocol: Web Protocols                              | HTTP POST to /api/daemon and /api/result for C2 communication                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Command and Control  | T1105 - Ingress Tool Transfer                                                      | AES-encrypted payloads downloaded from C2 via curl POST with authentication headers                                                                                                                                                                                                                                                                                                                                                                                                                     |
| Command and Control  | T1573.001 - Encrypted Channel: Symmetric Cryptography                              | AES-256-CBC with PBKDF2 key derivation used to encrypt payload transfers                                                                                                                                                                                                                                                                                                                                                                                                                                |
